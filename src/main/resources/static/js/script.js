...
<!--        </div>-->
        ...
        `<th><span>${days[key].substring(0, 3)}</span></th>`
                ...
                <div class="col-sm-3 col-sm-6 col-12 d-flex pa-sm">
                    <div class="card flex-fill d-none" id="event">
                        ...
                        <div class="card-body px-1 py-3">
                            ...
                            <div class="col-sm-auto rounded" style="background-color: #333a6e">
                            <a type="button" class="btn text-wrap" style="color: #f8f0f3" href="/events/add">Add
                                New Event
                            </a>
                        </div>
                    </div>
