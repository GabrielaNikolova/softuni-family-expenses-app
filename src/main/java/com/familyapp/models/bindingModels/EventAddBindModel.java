...
public class EventAddBindModel {
    ...
    public EventAddBindModel setEventName(String eventName) {
        this.eventName = eventName;
        return this;
    }

    public EventAddBindModel setEventDate(LocalDateTime eventDate) {
        this.eventDate = eventDate;
        return this;
    }

    public EventAddBindModel setLocation(String location) {
        this.location = location;
        return this;
    }

    public EventAddBindModel setBelongTo(String belongTo) {
        this.belongTo = belongTo;
        return this;
    }

    public EventAddBindModel setNote(String note) {
        this.note = note;
        return this;
    }
}
